...
import com.xiaojun.spacewar.scene.ManagedScene;
...
public class SceneManager extends Object{
	...
	private ManagedScene mChildScene;
	...
	public void showMainMenu() {
		Log.d(TAG, "打开游戏开始菜单！");
		showScene(MainMenuScene.getInstance());
	}
	...
	public void showChildScene(final ManagedScene pManagedScene) {
		mChildScene = pManagedScene;
		// Load and show the new managed scene, and set it as the current scene.
		mChildScene.onLoadManagedScene();
		mChildScene.onShowManagedScene();
		if(mCurrentScene != null) {
			mCurrentScene.setChildScene(mChildScene, false, true, true);
			Log.d("MainMenuScene", "靠！你还不给我出来1");
		}
	}
